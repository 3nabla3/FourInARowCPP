...
BOOST_AUTO_TEST_CASE(test_AnalyzeLine2) {
	...
	using BoardPiece::P1;
	using BoardPiece::P2;
	Score score = TreeNode::AnalyzeLine({EMPTY,	P2,		EMPTY,	P1,		EMPTY,	EMPTY, EMPTY},	Player::P1);
	...
	BOOST_CHECK_EQUAL((int)TreeNode::AnalyzeLine({EMPTY,	P2,		EMPTY,	P1,		EMPTY,	EMPTY, EMPTY},	Player::P1), 1);
}